...
def install(country=None):
    records = [
        ...
        # Mode of Payment
        {'doctype': 'Mode of Payment', 'mode_of_payment': _("Bank Check"),
            'type': 'Bank Check'},
        ...
        {'doctype': 'Mode of Payment', 'mode_of_payment': _('Bank Draft'),
            'type': 'Bank'},
        {'doctype': 'Mode of Payment', 'mode_of_payment': _("Third Party Bank Check"),
         'type': 'Third Party Bank Check'},
        {'doctype': 'Mode of Payment', 'mode_of_payment': _("Document"),
         'type': 'Document'},
        {'doctype': 'Mode of Payment', 'mode_of_payment': _("Third Party Document"),
         'type': 'Third Party Document'},
