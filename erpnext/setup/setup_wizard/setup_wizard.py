...
def create_fiscal_year_and_company(args):
    ...
    if (args.get('company_name')):
        ...
        set_accounts_to_mode_of_payments(args)
...
def set_accounts_to_mode_of_payments(args):

    bank_check = frappe.get_doc("Mode of Payment", _("Bank Check"))
    bank_account_name = frappe.get_value("Account",{"account_type": "Bank", "company": args.get("company_name")}, "name")
    bank_check.append("accounts", {"company": args.get("company_name"), "default_account": bank_account_name})
    bank_check.save()

    third_party_bank_check = frappe.get_doc("Mode of Payment", _("Third Party Bank Check"))
    check_wallet_account = frappe.get_value("Account",{"account_type": "Check Wallet", "company": args.get("company_name")}, "name")
    third_party_bank_check.append("accounts", {"company": args.get("company_name"), "default_account": check_wallet_account})
    third_party_bank_check.save()

    document = frappe.get_doc("Mode of Payment", _("Document"))
    document_account = frappe.get_value("Account",{"account_type": "Outgoing documents", "company": args.get("company_name")}, "name")
    document.append("accounts", {"company": args.get("company_name"), "default_account": document_account})
    document.save()

    third_party_document = frappe.get_doc("Mode of Payment", _("Third Party Document"))
    third_party_document_account = frappe.get_value("Account",{"account_type": "Document Wallet", "company": args.get("company_name")}, "name")
    third_party_document.append("accounts", {"company": args.get("company_name"), "default_account": third_party_document_account})
    third_party_document.save()
