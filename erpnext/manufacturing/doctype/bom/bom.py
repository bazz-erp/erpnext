    ...
    def validate_operations(self):
        ...
        if self.with_operations:
            for d in self.operations:
                ...
                # BAZZ - Operation cost is mandatory
                if d.operating_cost is None:
                    frappe.throw(_("{0} is mandatory in Operation").format(frappe.get_meta("BOM Operation").get_label("operating_cost")))
                d.base_operating_cost = d.operating_cost
